...
<link rel = "stylesheet"  href ="<c:url value = 'template/admin/assets/font-awesome/4.5.0/css/font-awesome.mincss' />" />
...
<body class="no-skin">
	...
	<div class="main-content" id="main-content">
		<script type="text/javascript">
				try{ace.settings.loadState('main-content, fixed')}catch(e){}
			</script>
